...
if run_diabetes:
    ...
    # Get the first row, first column of X
    first_value = X[0, 0]  # First column, first row (index [0, 0])

    # Print the value normally and as an ASCII character
    print(f"Regular value: {first_value}")
    print(f"ASCII character: {chr(int(first_value))}")
